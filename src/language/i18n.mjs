...
const resources = {
  ...
  tm: {
    translation: {
      ...
      ecoDescription:
        "Biziň kompaniýamyz gurluşyk we ekologiýa boýunça ýöriteleşdirilendir. Gurluşyk taslamalarynda, innowasion usullarynda we daşky gurşaw jogapkärçiligine ünsüni jemläp, ýaşaýyş, söwda we senagat desgalaryny gurmakda ýokary hil we howpsuzlyk ýörelgelerine eýerýäris. Ekologiýa pudagynda daşky gurşawy goramak, daşky gurşawa täsirini bahalandyrmak üçin taslamalary işläp düzmäge, şeýle hem, bu ýerdäki tebigy gurşawyň daşky gurşawyna, ykdysady we sosial parametrlerine hemmetaraplaýyn baha bermek ýaly hyzmatlary hödürleýäris. Hünärmenlerimiz, ekologiki gözegçiligi amala aşyrmak, taslamanyň daşky gurşawa täsirini öwrenmek we tebigaty goramak çärelerini öwrenmek üçin zerur bolan inžener-ekologiýa we geologiki gözlegleri geçirýärler. Mundan başga-da, suw çeşmelerini tygşytly peýdalanmak we hapa suwlary arassalamak üçin çözgütleri hödürläp, suwy arassalamak tehnologiýalary bilen işleýäris. Dünýäde barha gymmatly baýlyga öwrülýän suw, sosial-ykdysady ösüş üçin, kompaniýamyzyň işgärleri tebigata peýdaly tehnologiýalar bilen işleşmäge çalyşýar. ",
      ecoDesc3:
        "Häzirki döwürde suw durmuş-ykdysady ösüş üçin wajyp bolup durýär, her gün tertibinde  suw çeşmelerinden netijeli peýdalanmak we hapa suwlary arassalamak meseleleri çözgütleri göz öňünde tutulýar . Kompaniýamyz tebigata peýdaly tehnologiýalar bilen üpjün etmegi maksat edinýär.",
      ecoT1: "Gurluşyk",
      ecoT2: "Ekologiýa",
      ecoT3: "Suwy arassalamak",
      ecoDesc1:
        "Gurluşykda hil we howpsuzlyk meselelerinde özümizi tapawutlandyrýarys. Innowasiýa usullaryny ulanmaga we daşky gurşaw jogapkärçiligini ünsi çekip, Ýaşaýyş, söwda we senagat desgalaryny gurýarys.",
      ecoDesc2:
        "Kompaniýa daşky gurşawy goramak boýunça hyzmatlary hödürleýär, DGG taslamalaryny işläp düzýär, ykdysady obýektiň daşky gurşawyna täsirini, ykdysady we sosial parametrlerine giňişleýin öwrenýär we baha berýär we tejribäni taslamada utgaşdyrýar. Hünärmenlerimiz sebite ekologiki gözegçilik edýärler, obýektiň daşky gurşawa edýän jikme-jik täsirini öwrenmek we tebigaty goramak çärelerini hasaplamak üçin ähli zerur  inžener-ekologiýa we geologiki gözlegleri geçirýärler.",
      more: "Anyklamak",
      ...
      oilDesc1:
        "Nebit we gaz pudagynda hödürleýän hyzmatlarymyz we tekliplerimiz, suw howdanlarynyň we meýdan şertleriniň aýry-aýry parametrlerini göz öňünde tutup, fiziki, himiki we topragyň süzgüç aýratynlyklaryny derňemek üçin köp mümkinçilikleri hödürleýäris.",
      ...
      chemistryDesc1:
        "Himiki reagentler bilen üpjün etmekde esasy wezipämiz, dürli çylşyrymly gaz, gaz-kondensat we nebit guýularyny gurmakdaky zerurlyklary kanagatlandyrmakdyr. Reagentleriň giň topary, gaz we nebit guýularyny burawlamak, ösdürmek, düýpli abatlamak we abatlaşdyrmak işlerinde dürli meseleleri çözmäge mümkinçilik berýär.",
      chemTitle1: "Enjamlar",
      chemTitle2: "Himiýa",
      chemistryDesc2:
        "Nebit we gaz pudagy üçin enjamlar, giň assortimentdedir. Tebigy baýlyklary çykarmagy aňsatlaşdyrýan we ahyrky önümi almak üçin zerur bolan dürli manipulýasiýalara mümkinçilik berýär. Döwrebap inženerçilik çözgütleri, iş prosesleriniň howpsuzlygyny ýokarlandyrýan we daşky gurşawa ýaramaz täsirini azaldýan enjamlar bilen üpjün etmäge mümkinçilik berýär. ",
      chemistryDesc3:
        "Himiki reagentler bilen üpjün etmekde esasy wezipämiz, dürli çylşyrymly gaz, gaz-kondensat we nebit guýularyny gurmakdaky zerurlyklary kanagatlandyrmakdyr. Reagentleriň giň topary, gaz we nebit guýularyny burawlamak, ösdürmek, düýpli abatlamak we abatlaşdyrmak işlerinde dürli meseleleri çözmäge mümkinçilik berýär.",
      chemistryDesc:
        "Häzirki zaman nebit-gaz pudagy, önümçiligiň her bir döwründe - buraw guýularyndan we önümçilikden başlap, çig maly gaýtadan işlemek we soňraky daşamak üçin ulanylýan himiki we enjamlar toplumy bolmazdan netijeli işläp bilmeýär. Bu nukdaýnazardan peýdalanyp, kompaniýamyz hyzmatdaşlarymyzyň işini ýönekeýleşdirmek üçin zerur zatlar bilen üpjün etmäge çalyşýar we ýokary hilli önümler hödürleýär.",
