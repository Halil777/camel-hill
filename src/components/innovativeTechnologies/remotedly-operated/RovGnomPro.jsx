...
import {
  underwaterPartItemsPro,
  tetherItemsPro,
  cameraSystemItemsPro,
  lightingSystemItemsPro,
  telemetrySystemPro,
  surfaceControlUnitItemsPro,
  systemSetItemsPro,
} from "../../../data/data.mjs";

const RovGnomPro = ({ handleDrawerClose }) => {
          ...
          <>
            <Grid container>
              <Grid item lg={6} md={6} sm={12} xs={12}>
                <Stack spacing={3}>
                  {underwaterPartItemsPro.map((item, i) => (
                    <Typography
        ...
        return (
          <>
            <Grid container>
              <Grid item lg={6} md={6} sm={12} xs={12}>
                <Stack spacing={3}>
                  {cameraSystemItemsPro.map((item, i) => (
                    <Typography
                      key={`under_water_items_key${i}`}
                      color="#fff"
                      variant="h6"
        ...
        return (
          <>
            <Grid container>
              <Grid item lg={6} md={6} sm={12} xs={12}>
                <Stack spacing={3}>
                  {lightingSystemItemsPro.map((item, i) => (
                    <Typography
                      key={`under_water_items_key${i}`}
                      color="#fff"
                      variant="h6"
        ...
        return (
          <>
            <Grid container>
              <Grid item lg={6} md={6} sm={12} xs={12}>
                <Stack spacing={3}>
                  {surfaceControlUnitItemsPro.map((item, i) => (
                    <Typography
                      key={`under_water_items_key${i}`}
                      color="#fff"
                      variant="h6"
...
RovGnomPro.propTypes = {
  handleDrawerClose: PropTypes.func.isRequired,
};

export default RovGnomPro;
